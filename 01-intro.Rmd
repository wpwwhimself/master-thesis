...
- __epidemia SARS-CoV-2__ w listopadzie 2019 r. -- pandemia wywołana chorobą _COVID-19_ jest powodowana przez koronawirusa _SARS-CoV-2_,
a pierwszy zidentyfikowany przypadek zachorowania na&nbsp;tę chorobę został wykryty w grudniu 2019 roku w Wuhan (Chiny).
...
Szczególną zaletą modeli przełącznikowych jest możliwość uwzględnienia zmian we względnym poziomie zmienności -- parametru dyktującego intensywność wahań wartości szeregu czasowego.
