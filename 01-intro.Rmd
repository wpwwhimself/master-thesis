...
### Kwantyfikacja poprawności dopasowania modelu
...
W obrębie tej pracy stosowane są testy statystyczne, mające weryfikować następujące zagadnienia:

- normalność rozkładu zmiennej losowej -- test Shapiro-Wilka [@shapiroTest],
- istotność autokorelacji rzędu $l$ w obrębie szeregu czasowego -- test Ljung-Boxa [@boxTest],
- występowanie efektu ARCH w szeregu czasowym -- test McLeoda-Li [@mcLeodLiTest], test Engle'a [@engleARCH] oraz test KPSS [@KPSSTest].
