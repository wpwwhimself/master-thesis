...
W tym celu stosuje się _kryteria informacyjne_ -- wskaźniki opierające się na wartości funkcji wiarogodności $L$, które pozwalają na wyłonienie optymalnego modelu, który najwierniej opisuje dane zjawisko.
...
Do najpopularniejszych kryteriów informacyjnych należą [@zhangKryteriaInformacyjne]:
