...
Dla szeregu wartości modelowanych $(\hat{y}_i)$ formułuje się:

- $RMSE = \sqrt{\frac{1}{n} \sum_{i=1}^{n} \abs{\frac{y_i - \hat{y}_i}{y_i}}}$,
- $MAPE = \frac{1}{n} \sum_{i=1}^{n} \abs{\frac{y_i - \hat{y}_i}{y_i}}$.
