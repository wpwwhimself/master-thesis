...
Model ARMA sprawdza się szczególnie dobrze w zagadnieniach związanych z modelowaniem stóp procentowych \AAA{citation needed}.
...
co prowadzi do skomplikowanego modelu i wymaga dłuższych horyzontów czasowych \AAA{citation needed}.
...
- rozkłąd t Studenta -- liczba stopni swobody (kształt) $\nu$,
- rozkład skośny t Studenta -- liczba stopni swobody $\nu$, skośność $\xi = \exp(\lambda)$
- rozkład GED [@nelsonEGARCH, str. 352] -- kształt $\nu$.

\AAA{Parę słów o Markowie}
