...
Daje to 12 różnych modeli, które zostały przeanalizowane pod kątem kryteriów informacyjnych Akaike oraz Schwarza, a także pod względem istotności parametrów.
...
Można zauważyć, że najlepsze wyniki wykazuje model EGARCH (`eGARCH`), uwzględniający asymetrię wartości szeregu czasowego.
Badanie wykazało też brak konsensusu dotyczącego przyjętego rozkładu innowacji -- każdy z testowanych rozkładów pojawia się na liście najlepiej dopasowanych modeli.
...
\AAA{nieprawda, bo ebs refittowało dla beta2, a raczej nie powinno}
