...
\AAQ{msgarch nie potrafi obsługiwać modeli średniej -- w dokumentacji jest napisane, że trzeba zrobić "prefilter" -- co to znaczy?}

[link](https://cran.r-project.org/web/packages/MSGARCH/MSGARCH.pdf) -- strona 2
