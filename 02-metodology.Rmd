...
a niemal we wszystkich modelach współzależność między opóźnieniami obserwowanej zmienności $\beta$ jest wyraźnie silniejsza od tej związanej z autokorelacją reszt modelu liniowego $\alpha$.
...
Pierwszym z nich jest zmienna zero-jedynkowa,
...
Stoi za tym przekonanie, że nawet jeśli dana spółka nie jest składową tego indeksu,
...
Zaobserwowane wahania zmienności WIG20 będą wówczas odzwierciedlały wpływ czynników zewnętrznych dla każdej z analizowanych firm.
