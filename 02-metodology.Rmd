...
- McLeoda-Li (test Ljunga-Boxa dla kwadratów reszt z modelu),
- Engle'a -- zaimplementowany w pakiecie `rugarch` [@packageRugarch],
- KPSS -- zaimplementowany w pakiecie `tseries` [@packageTseries].
...
Prognozy zostały wykonane dla wariancji warunkowej na `r n_ahead` dni naprzód.
