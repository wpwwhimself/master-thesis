...
\usepackage{config/uepTitle}
	...
	\titleEN{Exploration of volatility of Polish stock exchange during crises with GARCH-X and Markov switching models}
	\thesisType{Praca magisterska}
	\author{Wojciech Przybyła}
	\supervisor{dr hab. Paweł Kliber, prof. UEP}
...
\newcommand{\xpcg}[1]{\overset{#1}{\pcg}}%pociąga z tekstem
...
\newcommand{\AAQ}[1]{{\color{green}{\textbf{[(?) #1]}}}}
\newcommand{\ghost}[1]{{\color{lightgray}{#1}}}
